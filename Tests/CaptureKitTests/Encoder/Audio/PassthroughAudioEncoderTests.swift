...
struct PassthroughAudioEncoderTests {
    ...
    func encodeReturnsDataUnchanged() async throws {
        ...
        let result = try await encoder.encode(data: inputData, timestamp: 1.0)
    ...
    func multipleEncodesWork() async throws {
        ...
        let result1 = try await encoder.encode(data: first, timestamp: 0.0)
        let result2 = try await encoder.encode(data: second, timestamp: 0.5)
        let result3 = try await encoder.encode(data: third, timestamp: 1.0)
    ...
    func encodePreservesFormat() async throws {
        ...
        let result = try await encoder.encode(data: inputData, timestamp: 2.5)
